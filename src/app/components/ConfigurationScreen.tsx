...
//                       {/* ⭐ FIX: Allow manual typing by removing the Math.max constraint during active typing */}
//                       <Input
//                         type="number"
//                         value={config.baseStation.surveyDuration || ''}
//                         onChange={(e) => {
...
//                         }}
//                         onBlur={(e) => {
//                           // Validate bounds only when the user finishes typing and leaves the field
...
//                     />
//                     <div className="relative">
//                       {/* ⭐ FIX: Allow free manual typing for accuracy as well for consistency */}
//                       <Input
//                         type="number" 
//                         value={config.baseStation.accuracyThreshold || ''}
//                         onChange={(e) => {
